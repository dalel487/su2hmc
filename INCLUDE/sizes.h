 ...
 * is smaller than on previous generations of GPUs
 */
extern sycl::range<3> dimBlock;    //	=dim3(nx,ny,nz);
extern sycl::range<3> dimGrid;     //	=dim3(nt,1,1);
                                   // For copying over gamval
extern sycl::range<3> dimBlockOne; //	=dim3(nx,ny,nz);
extern sycl::range<3> dimGridOne;  //	=dim3(nt,1,1);
#define	USE_BLAS
#endif
#endif
